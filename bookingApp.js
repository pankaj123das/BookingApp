...
function getDataFromApi(){
   axios.get('https://crudcrud.com/api/47ba8497528a4cc28989ae5ded6a5c55/appointmentData')
   .then(res=>{
...
function onSubmit(e) {
   ...
   if (nameEle.value == "" || emailEle.value == "") {
      ...
      axios.post('https://crudcrud.com/api/47ba8497528a4cc28989ae5ded6a5c55/appointmentData',myobj)
      .then(data =>{
         userList.innerHTML =""
      getDataFromApi();
         console.log(data)
...
function deleteUser(id){
   ...
   //localStorage.removeItem(`userdetail${email}`);
   axios.delete(`https://crudcrud.com/api/47ba8497528a4cc28989ae5ded6a5c55/appointmentData/${id}`)
   .then(res =>{
       userList.innerHTML =""
       getDataFromApi();
